...
public class AmethystDragonRenderer extends MobRenderer<AmethystDragonEntity, Modeldragon<AmethystDragonEntity>> {
	public AmethystDragonRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<AmethystDragonEntity, Modeldragon<AmethystDragonEntity>>(this) {
			@Override
