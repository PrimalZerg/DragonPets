...
public class IceDragonRenderer extends MobRenderer<IceDragonEntity, Modeldragon<IceDragonEntity>> {
	public IceDragonRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<IceDragonEntity, Modeldragon<IceDragonEntity>>(this) {
			@Override
