...
public class JungleDragonEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(DragonPetsModEntities.JUNGLE_DRAGON.get(), 80, 1, 1));
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(9, new TemptGoal(this, 1, Ingredient.of(Items.MELON_SLICE,Items.SWEET_BERRIES, Items.PORKCHOP, Items.CHICKEN, Items.BEEF, Items.MUTTON,Items.GOLDEN_APPLE), false));
